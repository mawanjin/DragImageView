 ...
 * Time: 17:09
 */
public class StretchImageView extends ImageView implements View.OnTouchListener{

    private static String TAG = StretchImageView.class.getName();
